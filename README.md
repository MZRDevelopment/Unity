...
A.1) Unity Bot'u sunucusuna ekleyen herkes bu politikaları kabul etmiş sayılır..
```
```
...
```
```
Unity bu maddeleri değiştirme ve düzenleme hakkını saklı tutar. 
```

# Unity Bot English Privacy Policy;

```
A. Login

A.1) Anyone who adds Unity to their server is deemed to have accepted these policies.
```
```
...
```
```
Unity reserves the right to change and edit these articles. 
```
